...
export default function Terminal({ onClose }: TerminalProps) {
  ...
  const commands: Record<string, () => string[]> = {
    help: () => [
      'Available commands:',
      '  about     - Learn about Ali Sherif',
      '  skills    - List technical skills',
      '  projects  - View featured projects',
      '  contact   - Get contact information',
      '  experience - Show work experience',
      '  languages - Display spoken languages',
      '  services  - Review consulting offerings',
      '',
      'Robotic Arm Controls:',
      '  arm       - Show arm control commands',
      '',
      'System:',
    ...
    arm: () => [
      ...
      '  • Move mouse to control arm position (IK enabled)',
      '  • Click to grab with gripper',
      '',
      'Keyboard Shortcuts:',
      '  P         - Toggle Performance Monitor overlay',
      '  Esc       - Close this terminal',
      '',
      'Features:',
      '  • Real-time inverse kinematics',
      '  • 5-DOF articulation',
      '  • Particle effects on grab',
      '  • Motion trails on arm segments',
      '  • Precision targeting aligned to cursor anywhere on screen',
      '',
    ],
    services: () => [
      'Service Offerings:',
      '──────────────────',
      '1. Robotics & Embedded R&D (Arduino, custom firmware, motion control)',
      '2. AI Product Engineering (LLM copilots, OCR/NLP workflows, agentic tooling)',
      '3. Full-Stack Delivery (Flutter/React frontends, Node/Go APIs, PostgreSQL)',
      '4. Infrastructure & DevOps (Docker, IaC, observability, cost optimization)',
      '',
      'Email ali@ashreef.com to scope a build or advisory engagement.',
      '',
    ],
    about: () => [
      'Ali Sherif (Ali Khalid Ahmed Sherif) | AshReef Labs',
      '─────────────────────────────────',
