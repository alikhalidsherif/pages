...
export default function Terminal({ onClose }: TerminalProps) {
  ...
  const commands: Record<string, () => string[]> = {
    ...
    easter: () => [
      ...
      '1. Konami Code',
      '   ↑ ↑ ↓ ↓ ← → ← → B A',
      '   Triggers a spectacular animation!',
      '',
      '2. Double-Click',
      '   Double-click anywhere to make the arm wave',
      '',
      '3. Slow Motion',
      '   Hold SHIFT key for slow-motion mode',
      '',
      '4. Teaching Mode',
      '   Press T to enable cursor following',
      '',
      '5. Performance Monitor',
      '   Press P to view FPS and arm telemetry',
      '',
